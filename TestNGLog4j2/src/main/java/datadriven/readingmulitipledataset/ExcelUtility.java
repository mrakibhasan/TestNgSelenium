package datadriven.readingmulitipledataset;
			...
			for (Cell cell : row) {
				...
				if (tableName.equals(formatter.formatCellValue(cell))) {
					if (pos.equalsIgnoreCase("begin")) {
						...
						System.out.println(cells[0]+" "+row.getRowNum()+cell.getColumnIndex());
						pos = "end";
					} else {
						cells[1] = (XSSFCell) cell;
						System.out.println(cells[1]+" "+row.getRowNum()+cell.getColumnIndex());
					}
				}
			}
		}
