package datadriven.readingdatafromxmlfile;
...
//	 Only works for Excel 2007+
	...
	public static void main(String[] args) {
		...
		String path = "D://Eclipse works Spaces//selenium//TestNGLog4j2//src//main//java//2-ExcelRead.xlsx";
		...
		try {
			...
			Cell = ExcelWSheet.getRow(0).getCell(2);
